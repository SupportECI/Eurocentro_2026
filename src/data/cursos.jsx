...
import { Languages, Activity, Shield, Star } from "lucide-react";
import italia from '/video/italia.mp4';
import francia from '/video/francia.mp4';
import usa from '/video/usa.mp4';
...
export const posts = [
  {
    ...
    age: "Inglés",
    videoBg: usa,
    icon: <svg width="30" height="20" viewBox="0 0 30 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    icon: <svg width="30" height="20" viewBox="0 0 30 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="30" height="20" fill="#F5F5F5" />
      <rect width="1876" height="988" transform="translate(-1830 -276)" fill="white" />
      <path d="M30 0H0V20H30V0Z" fill="#F0F0F0" />
  ...
  },
  {
    ...
    icon: <svg width="30" height="20" viewBox="0 0 30 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="30" height="20" fill="#F5F5F5" />
      <rect width="1876" height="988" transform="translate(-356 -432)" fill="white" />
